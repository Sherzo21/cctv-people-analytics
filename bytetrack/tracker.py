...
class BYTETracker:
    ...
    def update(self, detections: np.ndarray) -> np.ndarray:
        ...
        detections_high = [STrack(STrack._tlbr_to_tlwh(tlbr), s) for tlbr, s in zip(dets_high, scores_high)]
        detections_low = [STrack(STrack._tlbr_to_tlwh(tlbr), s) for tlbr, s in zip(dets_low, scores_low)]
